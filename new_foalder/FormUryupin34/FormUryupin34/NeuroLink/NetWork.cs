using _35._2_Akulov_project.NeuroNet;
using System;
...
namespace FormUryupin34.NeuroLink
{
    class Network
    {
        ...
        private HiddenLayer hidden_layer2 = new HiddenLayer(30, 72, NeuronType.Hidden, nameof(hidden_layer2));
        ...
        public void Train(Network net)
        {
            ...
            for (int k = 0; k < epoches; k++)//перебор эпох обучения
            {
                ...
                e_error_avr[k] /= net.input_layer.TrainSet.GetLength(0); //средняя энергия ошибки К-ой эпохи
            }
